...
local function Initialize()
  ...
  local Options       = {
    ...
    { type    = "checkbox",
      name    = BCUI.Loc("ResummonAfterAssist"),
      getFunc = function() return BCUI.Vars.ResummonAfterAssist end,
      setFunc = function(value) BCUI.Vars.ResummonAfterAssist = value BCUI.Menu.Refresh() end,
    },          
    { type    = "checkbox",
